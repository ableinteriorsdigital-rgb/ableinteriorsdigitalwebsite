...
export const metadata: Metadata = {
  ...
  description:
    "Transform your home with Able Interiors & Windows' bespoke interior solutions — modular kitchens, wardrobes, TV units, study areas, and complete home interiors in Chennai.",
